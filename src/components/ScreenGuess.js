...
export default function ScreenGuess({ word, round, totalRounds, onResult }) {
  ...
  return (
    <div className={styles.container}>
      ...
      {/* 4 caixas de progresso — mostram só ✓ ou ? sem revelar a letra */}
        ...
        {guess.map((l, i) => {
          ...
          return (
            <div key={i} className={`${styles.slot} ${styles[state]}`}>
              ...
              {/* Letra adivinhada mostra ✓, a atual mostra ?, as outras ficam vazias */}
      ...
      {/* Instrução — SEM mostrar a letra nem o boneco */}
      {slot < 4 && (
